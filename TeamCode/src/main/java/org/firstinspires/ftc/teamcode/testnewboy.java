...
public class testnewboy extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            driveFrontLeft.setPower(gamepad2.left_stick_y * .8);
            driveBackLeft.setPower(gamepad2.left_stick_y * .8);
            driveFrontRight.setPower(gamepad2.right_stick_y*.8);
            driveBackRight.setPower(gamepad2.right_stick_y*.8);
